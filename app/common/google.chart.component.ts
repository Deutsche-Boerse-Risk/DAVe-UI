...
export class GoogleChart implements OnInit, OnChanges, OnDestroy {
    ...
    public static prepareDataTableOrDataView(originalChartData: ChartData | google.visualization.DataTable | google.visualization.DataView): google.visualization.DataTable | google.visualization.DataView {
